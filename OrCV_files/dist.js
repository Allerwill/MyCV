...
LEQ */
/* cyrillic-ext */
/* Dăm ba cái JS có gì trong này đâu mà xem */
...
if (function(t, e) {
        ...
        function c(t, e, n, i) {
            if (ot.acceptData(t)) {
                var o, r, s = ot.expando,
                    ...
                    l = a ? ot.cache : t,
                    u = a ? t[s] : t[s] && s
                if (u && l[u] && (i || l[u].data) || void 0 !== n || "string" != typeof e) return u || (u = a ? t[s] = X.pop() || ot.guid++ : s), l[u] || (l[u] = a ? {} : {
                    toJSON: ot.noop
        ...
        function C(t, e) {
            ...
            if (1 === e.nodeType) {
                ...
                "script" === n && e.text !== t.text ? (b(e).text = t.text, x(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), nt.html5Clone && t.innerHTML && !ot.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && _t.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : ("input" === n || "textarea" === n) && (e.defaultValue = t.defaultValue)
            }
        }
        ...
        function S(t) {
            var e = ht,
                n = Kt[t]
            return n || (n = E(t, e), "none" !== n && n || (Jt = (Jt || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (Jt[0].contentWindow || Jt[0].contentDocument).document, e.write(), e.close(), n = E(t, e), Jt.detach()), Kt[t] = n), n
        }
        ...
        function N(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = ot._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Lt(i) && (r[s] = ot._data(i, "olddisplay", S(i.nodeName)))) : (o = Lt(i), (n && "none" !== n || !o) && ot._data(i, "olddisplay", o ? n : ot.css(i, "display"))))
        ...
        function z(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], u = ot.css(t, "display"), "inline" === ("none" === u ? ot._data(t, "olddisplay") || S(t.nodeName) : u) && "none" === ot.css(t, "float") && (nt.inlineBlockNeedsLayout && "inline" !== S(t.nodeName) ? d.zoom = 1 : d.display = "inline-block")), n.overflow && (d.overflow = "hidden", nt.shrinkWrapBlocks() || c.always(function() {
            ...
            if (ot.isEmptyObject(p)) "inline" === ("none" === u ? S(t.nodeName) : u) && (d.display = u)
                ...
                h ? "hidden" in h && (f = h.hidden) : h = ot._data(t, "fxshow", {}), r && (h.hidden = !f), f ? ot(t).show() : c.done(function() {
                    ot(t).hide()
                }), c.done(function() {
                    var e
                ...
                for (i in p) s = O(f ? h[i] : 0, i, c), i in h || (h[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        var ut = function(t) {
                ...
                if (A && !i) {
                    if (o = gt.exec(t))
                        if (s = o[1]) {
                            ...
                            } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && z(e, r) && r.id === s) return n.push(r), n
                        } else {
                        ...
                        if (f = d = H, h = e, m = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (p = C(t), (d = e.getAttribute("id")) ? f = d.replace(yt, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", u = p.length; u--;) p[u] = f + c(p[u])
            ...
            function p(t, e, n) {
                ...
                return e.first ? function(e, n, r) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || o) {
                                if (l = e[H] || (e[H] = {}), (a = l[i]) && a[0] === W && a[1] === r) return u[2] = a[2]
            ...
            function m(t, e, n, o, r, s) {
                return o && !o[H] && (o = m(o)), r && !r[H] && (r = m(r, s)), i(function(i, s, a, l) {
                    var u, c, p, d = [],
                        ...
                        b = n ? r || (i ? t : g || o) ? [] : s : y
                    if (n && n(y, b, a, l), o)
                        for (u = h(b, m), o(u, [], a, l), c = u.length; c--;)(p = u[c]) && (b[m[c]] = !(y[m[c]] = p))
                    if (i) {
                        if (r || t) {
                            if (r) {
            ...
            var y, b, x, w, T, C, E, S, k, L, N, _, $, D, A, j, I, O, z, H = "sizzle" + -new Date,
                M = t.document,
                W = 0,
                R = 0,
                P = n(),
            ...
            b = e.support = {}, T = e.isXML = function(t) {
                ...
                var e, n = t ? t.ownerDocument || t : M,
                    i = n.defaultView
                return n !== $ && 9 === n.nodeType && n.documentElement ? ($ = n, D = n.documentElement, A = !T(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                    _()
                ...
                }, I = [], j = [], (b.qsa = mt.test(n.querySelectorAll)) && (o(function(t) {
                    t.innerHTML = "<select msallowclip=''><option selected=''></option></select>", t.querySelectorAll("[msallowclip^='']").length && j.push("[*^$]=" + et + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || j.push("\\[" + et + "*(?:value|" + tt + ")"), t.querySelectorAll(":checked").length || j.push(":checked")
                }), o(function(t) {
                    var e = n.createElement("input")
                    e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && j.push("name" + et + "*[*^$|!~]?="), t.querySelectorAll(":enabled").length || j.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), j.push(",.*:")
                    ...
                    b.disconnectedMatch = O.call(t, "div"), O.call(t, "[s!='']:x"), I.push("!=", rt)
                }), j = j.length && new RegExp(j.join("|")), I = I.length && new RegExp(I.join("|")), e = mt.test(D.compareDocumentPosition), z = e || mt.test(D.contains) ? function(t, e) {
                    ...
                    return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === M && z(M, t) ? -1 : e === n || e.ownerDocument === M && z(M, e) ? 1 : L ? Z.call(L, t) - Z.call(L, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return N = !0, 0
                    var i, o = 0,
                        r = t.parentNode,
                ...
                if ((t.ownerDocument || t) !== $ && _(t), n = n.replace(ut, "='$1']"), !(!b.matchesSelector || !A || I && I.test(n) || j && j.test(n))) try {
                    var i = O.call(t, n)
                ...
                var e, n = [],
                    i = 0,
                    o = 0
                if (N = !b.detectDuplicates, L = !b.sortStable && t.slice(0), t.sort(B), N) {
                        ...
                        return 1 === i && 0 === o ? function(t) {
                            ...
                            if (g) {
                                ...
                                if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (c = g[H] || (g[H] = {}), u = c[t] || [], f = u[0] === W && u[1], d = u[0] === W && u[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (d = f = 0) || h.pop();)
                                        if (1 === p.nodeType && ++d && p === e) {
                                            c[t] = [W, f, d]
                                            break
                                        }
                                } else if (y && (u = (e[H] || (e[H] = {}))[t]) && u[0] === W) d = u[1]
                                else
                                    for (;
                                        (p = ++f && p && p[m] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[H] || (p[H] = {}))[t] = [W, d]), p !== e)););
            ...
            return u.prototype = x.filters = x.pseudos, x.setFilters = new u, C = e.tokenize = function(t, n) {
                ...
                for (a = t, l = [], u = x.preFilter; a;) {
                    ...
                    for (s in x.filter) !(o = dt[s].exec(a)) || u[s] && !(o = u[s](o)) || (i = o.shift(), r.push({
                        value: i,
                        type: s,
                        matches: o
                    }), a = a.slice(i.length))
                ...
                var n, i = [],
                    ...
                    r = q[t + " "]
                if (!r) {
                    for (e || (e = C(t)), n = e.length; n--;) r = g(e[n]), r[H] ? i.push(r) : o.push(r)
                ...
                if (n = n || [], 1 === d.length) {
                    if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && b.getById && 9 === e.nodeType && A && x.relative[r[1].type]) {
                ...
                return (p || E(t, d))(i, e, !A, n, vt.test(t) && l(e.parentNode) || e), n
            }, b.sortStable = H.split("").sort(B).join("") === H, b.detectDuplicates = !!N, _(), b.sortDetached = o(function(t) {
        ...
        (ot.fn.init = function(t, e) {
            ...
            if ("string" == typeof t) {
                ...
                if (n[1]) {
                    if (e = e instanceof ot ? e[0] : e, ot.merge(this, ot.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : ht, !0)), pt.test(n[1]) && ot.isPlainObject(e))
            ...
            return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : ot.isFunction(t) ? void 0 !== ft.ready ? ft.ready(t) : t(ot) : (void 0 !== t.selector && (this.selector = t.selector, this.context = t.context), ot.makeArray(t, this))
        }).prototype = ot.fn, ft = ot(ht)
        ...
        ot.fn.ready = function(t) {
            ...
            ready: function(t) {
                if (!0 === t ? !--ot.readyWait : !ot.isReady) {
                    ...
                    ot.isReady = !0, !0 !== t && --ot.readyWait > 0 || (xt.resolveWith(ht, [ot]), ot.fn.triggerHandler && (ot(ht).triggerHandler("ready"), ot(ht).off("ready")))
                }
            }
        ...
        ot.event = {
            ...
            add: function(t, e, n, i, o) {
                ...
                if (g) {
                    for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = ot.guid++), (s = g.events) || (s = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                        ...
                        }, c.elem = t), e = (e || "").match(yt) || [""], a = e.length; a--;) r = It.exec(e[a]) || [], f = m = r[1], h = (r[2] || "").split(".").sort(), f && (u = ot.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = ot.event.special[f] || {}, p = ot.extend({
                        type: f,
                        origType: m,
                        data: i,
                        handler: n,
                        ...
                        namespace: h.join(".")
                    }, l), (d = s[f]) || (d = s[f] = [], d.delegateCount = 0, u.setup && !1 !== u.setup.call(t, i, h, c) || (t.addEventListener ? t.addEventListener(f, c, !1) : t.attachEvent && t.attachEvent("on" + f, c))), u.add && (u.add.call(t, p), p.handler.guid || (p.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, p) : d.push(p), ot.event.global[f] = !0)
                    t = null
                }
            },
            remove: function(t, e, n, i, o) {
                ...
                if (g && (c = g.events)) {
                    for (e = (e || "").match(yt) || [""], u = e.length; u--;)
                        if (a = It.exec(e[u]) || [], f = m = a[1], h = (a[2] || "").split(".").sort(), f) {
                            for (p = ot.event.special[f] || {}, f = (i ? p.delegateType : p.bindType) || f, d = c[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = d.length; r--;) s = d[r], !o && m !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (d.splice(r, 1), s.selector && d.delegateCount--, p.remove && p.remove.call(t, s))
                            l && !d.length && (p.teardown && !1 !== p.teardown.call(t, h, g.handle) || ot.removeEvent(t, f, g.handle), delete c[f])
                        } else
            ...
            trigger: function(e, n, i, o) {
                ...
                if (a = c = i = i || ht, 3 !== i.nodeType && 8 !== i.nodeType && !jt.test(f + ot.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), s = f.indexOf(":") < 0 && "on" + f, e = e[ot.expando] ? e : new ot.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ot.makeArray(n, [e]), u = ot.event.special[f] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, n))) {
                    ...
                    for (p = 0;
                        (a = d[p++]) && !e.isPropagationStopped();) e.type = p > 1 ? l : u.bindType || f, r = (ot._data(a, "events") || {})[e.type] && ot._data(a, "handle"), r && r.apply(a, n), (r = s && a[s]) && r.apply && ot.acceptData(a) && (e.result = r.apply(a, n), !1 === e.result && e.preventDefault())
                    if (e.type = f, !o && !e.isDefaultPrevented() && (!u._default || !1 === u._default.apply(d.pop(), n)) && ot.acceptData(i) && s && i[f] && !ot.isWindow(i)) {
            ...
            return this instanceof ot.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? d : f) : this.type = t, e && ot.extend(this, e), this.timeStamp = t && t.timeStamp || ot.now(), void(this[ot.expando] = !0)) : new ot.Event(t, e)
        }, ot.Event.prototype = {
        ...
        Xt.optgroup = Xt.option, Xt.tbody = Xt.tfoot = Xt.colgroup = Xt.caption = Xt.thead, Xt.th = Xt.td, ot.extend({
            clone: function(t, e, n) {
                ...
                if (nt.html5Clone || ot.isXMLDoc(t) || !Ht.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Gt.innerHTML = t.outerHTML, Gt.removeChild(r = Gt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t)))
                    for (i = g(r), a = g(t), s = 0; null != (o = a[s]); ++s) i[s] && C(o, i[s])
                if (e)
                    if (n)
                        for (a = a || g(t), i = i || g(r), s = 0; null != (o = a[s]); s++) T(o, i[s])
                else T(t, r)
            ...
            buildFragment: function(t, e, n, i) {
                for (var o, r, s, a, l, u, c, p = t.length, d = m(e), f = [], h = 0; p > h; h++)
                    ...
                    for (a = a || d.appendChild(e.createElement("div")), l = (Rt.exec(r) || ["", ""])[1].toLowerCase(), c = Xt[l] || Xt._default, a.innerHTML = c[1] + r.replace(Wt, "<$1></$2>") + c[2], o = c[0]; o--;) a = a.lastChild
                    if (!nt.leadingWhitespace && Mt.test(r) && f.push(e.createTextNode(Mt.exec(r)[0])), !nt.tbody)
                        for (r = "table" !== l || Pt.test(r) ? "<table>" !== c[1] || Pt.test(r) ? 0 : a : a.firstChild, o = r && r.childNodes.length; o--;) ot.nodeName(u = r.childNodes[o], "tbody") && !u.childNodes.length && r.removeChild(u)
                    for (ot.merge(f, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild)
                    a = d.lastChild
                } else f.push(e.createTextNode(r))
                for (a && d.removeChild(a), nt.appendChecked || ot.grep(g(f, "input"), v), h = 0; r = f[h++];)
                    if ((!i || -1 === ot.inArray(r, i)) && (s = ot.contains(r.ownerDocument, r), a = g(d.appendChild(r), "script"), s && w(a), n))
            ...
            cleanData: function(t, e) {
                for (var n, i, o, r, s = 0, a = ot.expando, l = ot.cache, u = nt.deleteExpando, c = ot.event.special; null != (n = t[s]); s++)
                    if ((e || ot.acceptData(n)) && (o = n[a], r = o && l[o])) {
                        ...
                        l[o] && (delete l[o], u ? delete n[a] : typeof n.removeAttribute !== Tt ? n.removeAttribute(a) : n[a] = null, X.push(o))
                    }
            }
        }), ot.fn.extend({
            text: function(t) {
            ...
            remove: function(t, e) {
                for (var n, i = t ? ot.filter(t, this) : this, o = 0; null != (n = i[o]); o++) e || 1 !== n.nodeType || ot.cleanData(g(n)), n.parentNode && (e && ot.contains(n.ownerDocument, n) && w(g(n, "script")), n.parentNode.removeChild(n))
                return this
            },
            empty: function() {
            ...
            domManip: function(t, e) {
                ...
                var n, i, o, r, s, a, l = 0,
                    ...
                    d = t[0],
                    f = ot.isFunction(d)
                if (f || u > 1 && "string" == typeof d && !nt.checkClone && Bt.test(d)) return this.each(function(n) {
                    var i = c.eq(n)
                ...
                if (u && (a = ot.buildFragment(t, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                    ...
                    if (o)
                        for (s = r[r.length - 1].ownerDocument, ot.map(r, x), l = 0; o > l; l++) i = r[l], Ut.test(i.type || "") && !ot._data(i, "globalEval") && ot.contains(s, i) && (i.src ? ot._evalUrl && ot._evalUrl(i.src) : ot.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Qt, "")))
                    a = n = null
                }
                return this
            }
        ...
        ot.extend({
            ...
            css: function(t, e, n, i) {
                var o, r, s, a = ot.camelCase(e)
                return e = ot.cssProps[a] || (ot.cssProps[a] = L(t.style, a)), s = ot.cssHooks[e] || ot.cssHooks[a], s && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = te(t, e, i)), "normal" === r && e in ce && (r = ce[e]), "" === n || n ? (o = parseFloat(r), !0 === n || ot.isNumeric(o) ? o || 0 : r) : r
            }
        ...
        var xe, we, Te = ot.expr.attrHandle,
        ...
        ot.fn.extend({
            ...
            attr: function(t, e, n) {
                var i, o, r = t.nodeType
                if (t && 3 !== r && 8 !== r && 2 !== r) return typeof t.getAttribute === Tt ? ot.prop(t, e, n) : (1 === r && ot.isXMLDoc(t) || (e = e.toLowerCase(), i = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? we : xe)), void 0 === n ? i && "get" in i && null !== (o = i.get(t, e)) ? o : (o = ot.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void ot.removeAttr(t, e))
            },
            removeAttr: function(t, e) {
                var n, i, o = 0,
                    r = e && e.match(yt)
                if (r && 1 === t.nodeType)
                    for (; n = r[o++];) i = ot.propFix[n] || n, ot.expr.match.bool.test(n) ? Se && Ee || !Ce.test(n) ? t[i] = !1 : t[ot.camelCase("default-" + n)] = t[i] = !1 : ot.attr(t, n, ""), t.removeAttribute(Ee ? n : i)
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            set: function(t, e, n) {
                return !1 === e ? ot.removeAttr(t, n) : Se && Ee || !Ce.test(n) ? t.setAttribute(!Ee && ot.propFix[n] || n, n) : t[ot.camelCase("default-" + n)] = t[n] = !0, n
            }
        ...
        ot.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(ot.isFunction(t) ? function(n) {
                    ...
                    else(n === Tt || "boolean" === n) && (this.className && ot._data(this, "__className__", this.className), this.className = this.className || !1 === t ? "" : ot._data(this, "__className__") || "")
                })
            },
            hasClass: function(t) {
        ...
        Ae = Re.exec(je.toLowerCase()) || [], ot.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
        ...
        ot.ajaxSetup({
            ...
            if (!t || "string" != typeof t) return null "boolean" == typeof e && (n = e, e = !1), e = e || ht
            var i = pt.exec(t),
                o = !n && []
        ...
        ot.offset = {
            ...
            offset: function(t) {
                ...
                var e, n, i = {
                    ...
                    o = this[0],
                    r = o && o.ownerDocument
                return r ? (e = r.documentElement, ot.contains(e, o) ? (typeof o.getBoundingClientRect !== Tt && (i = o.getBoundingClientRect()), n = Q(r), {
...
function(t) {
    ...
    function e(e) {
        return this.each(function() {
            var i = t(this),
                ...
                r = t.extend({}, n.DEFAULTS, i.data(), "object" == typeof e && e) !o && r.toggle && "show" == e && (e = !e),
                o || i.data("bs.collapse", o = new n(this, r)), "string" == typeof e && o[e]()
        })
    }
    var n = function(e, i) {
    ...
    t.fn.collapse = e, t.fn.collapse.Constructor = n, t.fn.collapse.noConflict = function() {
        ...
        var i, o = t(this),
            ...
            c = u && t(u)
        a && a.transitioning || (c && c.find('[data-toggle="collapse"][data-parent="' + u + '"]').not(o).addClass("collapsed"), o[s.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), e.call(s, l)
    })
}(jQuery),
function(t) {
    "use strict"
...
function(t) {
    ...
    n.VERSION = "3.2.0", n.DEFAULTS = {
        ...
        var l = i[0].offsetWidth,
            u = i[0].offsetHeight "top" == n && u != r && (e.top = e.top + r - u)
    ...
    n.VERSION = "3.2.0", n.RESET = "affix affix-top affix-bottom", n.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var e = t(document).height(),
                ...
                s = r.top,
                a = r.bottom "object" != typeof r && (a = s = r),
                "function" == typeof s && (s = r.top(this.$element)), "function" == typeof a && (a = r.bottom(this.$element))
...
function(t) {
    ...
    e.resize(function() {
        ...
        u.each(function() {
            ...
            return t.height()
        }, (arguments.length < 1 || null === i) && (i = "50%"), (arguments.length < 2 || null === o) && (o = .1), (arguments.length < 3 || null === r) && (r = !0), e.bind("scroll", s).resize(s), s()
    }
}(jQuery),
function(t) {
    function e() {}
    ...
    var i = Array.prototype.slice "function" == typeof define && define.amd ? define("jquery-bridget/jquery.bridget", ["jquery"], n) : n(t.jQuery)
}(window),
function(t) {
    function e(e) {
        var n = t.event
...
function() {
            ...
            function i(t) {
                if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    var g = o.paddingLeft + o.paddingRight,
                        ...
                        T = c && l,
                        C = e(i.width) !1 !== C && (o.width = C + (T ? 0 : g + x))
                    var E = e(i.height)
                    return !1 !== E && (o.height = E + (T ? 0 : v + w)), o.innerWidth = o.width - (g + x), o.innerHeight = o.height - (v + w), o.outerWidth = o.width + y, o.outerHeight = o.height + b, o
                }
            }
    ...
    function(t, e) {
        ...
        if (a) {
            var l = document.createElement("div"),
                u = n(l, "div")
            s = u ? n : r
        } else s = o "function" == typeof define && define.amd ? define("matches-selector/matches-selector", [], function() {
            return s
    ...
    function(t) {
    ...
    }(window), window.scrollReveal = function(t) {
        "use strict"

        function e(t) {
            this.options = this.extend(this.defaults, t), this.docElem = this.options.elem, this.styleBank = {}, 1 == this.options.init && this.init()
        }
        var n = 1,
            i = function() {
        ...
        return e.prototype = {
            ...
            init: function() {
                this.scrolled = !1
                var e = this
                this.elems = Array.prototype.slice.call(this.docElem.querySelectorAll("[data-scroll-reveal]")), this.elems.forEach(function(t, i) {
                ...
                var o = function(t) {
                        e.scrolled || (e.scrolled = !0, i(function() {
                            e._scrollPage()
                        }))
                    },
                    r = function() {
                ...
                this.docElem == t.document.documentElement ? (t.addEventListener("scroll", o, !1), t.addEventListener("resize", r, !1)) : this.docElem.addEventListener("scroll", o, !1)
            },
            ...
            update: function(t) {
                ...
                return null != i ? i += ";" : i = "", t.getAttribute("data-scroll-reveal-initialized") || (t.setAttribute("style", i + n.initial), t.setAttribute("data-scroll-reveal-initialized", !0)), this.isElementInViewport(t, this.options.viewportFactor) ? t.getAttribute("data-scroll-reveal-complete") ? void 0 : this.isElementInViewport(t, this.options.viewportFactor) ? (t.setAttribute("style", i + n.target + n.transition), void(this.options.reset || setTimeout(function() {
                    "" != i ? t.setAttribute("style", i) : t.removeAttribute("style"), t.setAttribute("data-scroll-reveal-complete", !0), e.options.complete(t)
...
jQuery(window).scroll(function() {
        "use strict"
        jQuery(this).scrollTop() > $("#banner").height() ? (siteNav.addClass("navbar-fixed-top"), siteNav.removeClass("navbar-static-top"), topStatic.addClass("menu-margin")) : (siteNav.addClass("navbar-static-top"), siteNav.removeClass("navbar-fixed-top"), topStatic.removeClass("menu-margin"))
    }), $(window).width() < 966 && (mainNav.removeClass("top-fixed"), mainNav.addClass("side-static"), menuSecond.removeClass("container")), jQuery(".menu-switch").click(function() {
        "use strict"
    ...
    }), jQuery("#banner").parallax("50%", .5), $(".pro-skills").each(function() {
    ...
    function(t) {
        ...
        function e(t, e, n, i) {
            if (i || (i = 1e3), r(e, n), 1 != u.accelerationMax) {
                var o = +new Date - h
                o < u.accelerationDelta && 1 < (o = (1 + 30 / o) / 2) && (o = Math.min(o, u.accelerationMax), e *= o, n *= o), h = +new Date
            }
            if (d.push({
                    x: e,
                    y: n,
                ...
                var s = t === document.body,
                    l = function(o) {
                        ...
                        for (var r = 0, c = 0, p = 0; p < d.length; p++) {
                            ...
                            u.pulseAlgorithm && (y = a(y)), m = h.x * y - h.lastX >> 0, y = h.y * y - h.lastY >> 0, r += m, c += y, h.lastX += m, h.lastY += y, g && (d.splice(p, 1), p--)
                        }
                        s ? window.scrollBy(r, c) : (r && (t.scrollLeft += r), c && (t.scrollTop += c)), e || n || (d = []), d.length ? v(l, t, i / u.frameRate + 1) : f = !1
                    }
                v(l, t, 0), f = !0
            }
        }
        ...
        function n(t) {
            ...
            var i = t.wheelDeltaX || 0,
                r = t.wheelDeltaY || 0
            i || r || (r = t.wheelDelta || 0), 1.2 < Math.abs(i) && (i *= u.stepSize / 120), 1.2 < Math.abs(r) && (r *= u.stepSize / 120), e(n, -i, -r), t.preventDefault()
        }
        ...
        function o(t) {
            ...
            do {
                ...
                } else if (t.clientHeight + 10 < t.scrollHeight && ("scroll" === (n = getComputedStyle(t, "").getPropertyValue("overflow-y")) || "auto" === n)) return i(e, t)
            } while (t = t.parentNode)
        }

        function r(t, e) {
            t = 0 < t ? 1 : -1, e = 0 < e ? 1 : -1, c.x === t && c.y === e || (c.x = t, c.y = e, d = [], h = 0)
        }

        function s(t) {
            var e
            return t *= u.pulseScale, 1 > t ? e = t - (1 - Math.exp(-t)) : (e = Math.exp(-1), t = 1 - Math.exp(-(t - 1)), e += t * (1 - e)), e * u.pulseNormalize
        }

        function a(t) {
            return 1 <= t ? 1 : 0 >= t ? 0 : (1 == u.pulseNormalize && (u.pulseNormalize /= s(1)), s(t))
        }
        var l = {
                frameRate: 150,
                animationTime: 1200,
